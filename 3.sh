...
clear;toilet -t -f mono12  "Nafiz" --gay -F border
echo ""
PUT 11 40
echo -e "\e[92mBy\e[1;93m Nafiz Sheikh\e[1;95m /\e[1;96m Nafiz "
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36mNafiz Sheikh \e[93m/ \e[100;92mNafiz tech & Hacking"
echo
...
sed -e "s/\Nafiz/$name/g" .nafiz.zsh-theme > $HOME/.oh-my-zsh/themes/nafiz.zsh-theme
