...
banner() {
    ...
    echo -e "${R} [!]${W} Author  : ${C}Nafiz Sheikh (Nafiz)"
    echo -e "${R} [!]${W} Version : ${Y}v3.5 (Stable)"
    echo -e "${R} [!]${W} Youtube : ${W}Nafiz tech & hacking"
    echo -e "${R} [!]${W} GitHub  : ${W}github.com/nafiz1000x"
    echo -e ""
...
10line() { rm -rf ~/Termux-os; cd; git clone https://github.com/nafiz1000x/Termux-os; cd ~/Termux-os ; bash os.sh; }
8line() {
